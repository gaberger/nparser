...
## Run program
```
At the moment this is running tests from ncp-parser.frr.core-test for validation soon I will
add command line arguments to process configurations and a service endpoint
```


`clj -m ncp-parser.frr.core`


## Sample Configuration

[https://raw.githubusercontent.com/gaberger/ncp_parser/master/resources/configs/frr/router1.cfg]
...
```(frr (slurp (io/resource "configs/frr/router1.cfg")))```
